...
export default function Card({image , imageInfo , name , hoverStyle , view , id} : {image : string , imageInfo : string , name : string , hoverStyle : string , view : string , id : string}) {
  return (
    <>
    <Link className="group bg-white rounded-2xl border border-gray-100 p-4 sm:p-5 shadow-sm hover:shadow-xl hover:border-violet-200 transition-all duration-300 hover:-translate-y-1" href={id}>
