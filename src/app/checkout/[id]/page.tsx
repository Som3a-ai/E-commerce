...
import { pay } from "@/actions/checkout.action";
...
export default function page() {
  ...
  async function mySubmit(obj: CheckOutType) {
    const res = await pay(id, obj, isVisa);
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
              ...
              <div className="p-6 space-y-4">
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-xl flex items-center justify-center transition-all  ${!isVisa ? "bg-gradient-to-br from-green-500 to-green-600 text-white shadow-lg shadow-green-500/30" : "bg-gray-100 text-gray-400 group-hover:bg-gray-200"} `}
                  >
                  ...
                  <div className="flex-1 text-left">
                    <h3
                      className={`font-bold text-green-700 ${!isVisa ? "text-green-600" : "text-gray-900"}`}
                    >
                      Cash on Delivery
                    </h3>
                  ...
                  <div
                    className={`w-7 h-7 rounded-full flex items-center justify-center transition-all ${!isVisa ? "bg-green-600 text-white" : "border-gray-200"} `}
                  >
                ...
                <div className="space-y-3 max-h-56 overflow-y-auto mb-5 pr-1">
                  {userOrders?.products &&
                    userOrders.products.map((product) => {
                      return (
                        <CheckOutCards key={product._id} product={product} />
                      );
                    })}
                </div>
